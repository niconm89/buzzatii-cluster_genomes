 ...
 for species in Dato Dbrb DkoeA DkoeB;
  ...
  canu -correct -p ${species} -d . genomeSize=160m -useGrid=true -maxThreads=16 -maxMemory=90 -gridEngineThreadsOption="-l select=1:ncpus=16:mem=100gb" -gridEngineMemoryOption="-l walltime=02:00:00" -gridOptions="-W group_list=cactophilic -q windfall" -pacbio-raw ${READS}/${species}.pacbio.fa.gz
 ...
 WD=/home/nmoreyra/cbuzz/03_Assembly/04_Pilon
 READS=/home/nmoreyra/cbuzz/00_RawData/Illumina
 ALIGNDIR=/home/nmoreyra/cbuzz/03_Assembly/04_Pilon/Alignment

 for species in Dato Dbrb DkoeA DkoeB;
  cd ${WD}/${species}
  REF=/home/nmoreyra/cbuzz/03_Assembly/03_Arrow/${species}/

  bowtie2-build ${REF}/${species}.arrow_polished.fa ${REF}/${species}.arrow_polished.fa

  bowtie2 --threads 28 -X 550 -x ${REF}/${species}.arrow_polished.fa -1 ${READS}/${species}.PE.cutadapt.prinseq.R1.fq -2 ${READS}/${species}.PE.cutadapt.prinseq.R2.fq -S ${ALIGNDIR}/IlluminaPE_to_arrow.sam
 ...
 for species in Dato Dbrb DkoeA DkoeB; do
  CONTIGS=/rsgrps/lmatzkin/nmoreyra/assemblies/Dspecies/Dkoepferae/Dko7.1/Platanus_different_coverages/mix
  DATA=/rsgrps/lmatzkin/nmoreyra/Dspecies/Dkoepferae/Dko7.1/PacBio
  WORKDIR=/rsgrps/lmatzkin/nmoreyra/assemblies/Dspecies/Dkoepferae/Dko7.1/Hybrid_assembly/DBG2OLC/Dko7.1_DBG_Plat5

 cd $WORKDIR
 DBG2OLC k 17 KmerCovTh 2 MinOverlap 30 AdaptiveTh 0.01 LD 0 MinLen 200 Contigs $CONTIGS/Dko7.1_plat_mix_contig.fa RemoveChimera 1 f $DATA/Sequel/Dko7.1_pb_sequel.fasta f $DATA/RSII/Dko_pb_LR.fasta
